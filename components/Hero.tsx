  ...
  return (
    <section className="relative overflow-hidden bg-asphalt">
      <div className="absolute inset-0">
        <Image
          src="/images/3.png"
          alt={`${business.name} exterior at night on the Islamabad motorway`}
          fill
          priority
      ...
      <div className="relative mx-auto max-w-6xl px-5 pt-24 pb-20 md:pt-36 md:pb-28">
        <p className="marker-label text-amber mb-4">Islamabad Main motorway · Open 24 Hours</p>
        <h1 className="font-display text-4xl sm:text-5xl md:text-7xl tracking-wide text-concrete leading-[0.95] max-w-3xl">
          A Trusted Place to Rest, Right on the Islamabad motorway.
        </h1>
        <p className="mt-6 max-w-xl text-concrete/80 text-base md:text-lg leading-relaxed">
          For travelers from every district and from across borders, {business.name} has been a reliable choice for clean rooms, fair prices, and a welcome that never depends on the hour you arrive.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          <CtaLink href="/rooms/" variant="amber" icon="arrow">
            Check Room Availability
          </CtaLink>
          <CtaLink href="/rooms/" variant="outline" icon="arrow">
            Buy Room
          </CtaLink>
