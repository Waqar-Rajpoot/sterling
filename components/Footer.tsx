  ...
  return (
    <footer className="bg-asphalt text-concrete/80">
      ...
      <div className="mx-auto max-w-6xl px-5 py-14 grid gap-10 md:grid-cols-3">
        <div>
          <span className="font-display text-xl tracking-wide text-concrete">AL-MANZIL</span>
          <p className="mt-3 text-sm leading-relaxed max-w-xs">
            A dependable stop on the Multan highway — clean rooms, fair prices, and a door
