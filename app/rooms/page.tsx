...
export const metadata: Metadata = {
  ...
  description: "Standard, Family, and Deluxe rooms at Al-Manzil Guest House on the Multan highway — clean, secure, and ready any hour.",
};
  ...
  return (
    <>
      <PageHeaderBanner
        eyebrow="Rooms"
        title="Our Rooms"
        subtitle="Every room at Al-Manzil is cleaned and inspected before check-in. Choose the option that fits your trip — from a quick overnight stop to a stay with the whole family."
      />
