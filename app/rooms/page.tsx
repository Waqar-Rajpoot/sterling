...
export const metadata: Metadata = {
  ...
  description: "Standard, Family, and Deluxe rooms at Sterlingone Hospitality motorway Stop on the Islamabad motorway. clean, secure, and ready any hour.",
};
  ...
  return (
    <>
      <PageHeaderBanner
        eyebrow="Rooms"
        title="Our Rooms"
        subtitle="Every room at Sterlingone Hospitality motorway Stop is cleaned and inspected before check-in. Choose the option that fits your trip from a quick overnight stop to a stay with the whole family."
      />
